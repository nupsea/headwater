...
MYSQL_PREVIEW_CAPABILITIES = ConnectorCapabilities(
    list_schemas=True,
    list_tables=True,
    list_columns=True,
    list_constraints=False,
...
SNOWFLAKE_PREVIEW_CAPABILITIES = ConnectorCapabilities(
    list_schemas=True,
    list_tables=True,
    list_columns=True,
    list_constraints=False,
...
REDSHIFT_PREVIEW_CAPABILITIES = ConnectorCapabilities(
    list_schemas=True,
    list_tables=True,
    list_columns=True,
    list_constraints=False,
